...
public class ArticleDetailFragment extends Fragment implements
    ...
    private boolean isCollapsingLayout = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        isCollapsingLayout = getResources().getBoolean(R.bool.is_collapsing_layout);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (isCollapsingLayout) {
            mToolbarLayout = mRootView.findViewById(R.id.collapsing_toolbar);
            ...
            appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
                ...
                public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                    ...
                    if (scrollRange + verticalOffset == 0) {
                        mToolbarLayout.setTitle(mCursor.getString(Query.TITLE));
                        mToolbarLayout.setCollapsedTitleTextColor(Color.WHITE);
                        mToolbarLayout.setCollapsedTitleGravity(Gravity.CENTER_HORIZONTAL);
                        isShow = true;
                    } else if (isShow) {
                        mToolbarLayout.setTitle(null);
                        isShow = false;
                    }
                }
            });
